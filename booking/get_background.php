...
if ($validasi != 'YES') {
	...
	$html .= "<option value=''>" . 'Silahkan Pilih Paket' . "    </option>"; // Tambahkan tag option ke variabel $html
...
$callback = array('data_subkategori1' => $html); // Masukan variabel html tadi ke dalam array $callback dengan index array : data_kota
