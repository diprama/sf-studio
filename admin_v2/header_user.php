...
<head>
    ...
    <link rel="apple-touch-icon" href="../app-assets/images/logo/libra3.png">
    <link rel="shortcut icon" style='width:5%' type="image/x-icon" href="../app-assets/images/logo/libra3.png">
...
<body class="horizontal-layout horizontal-menu  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="">
    ...
    <?php include 'header_user_top.php'; ?>
    <?php include 'header_user_sidemenu.php'; ?>